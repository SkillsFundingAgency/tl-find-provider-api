...
namespace Sfa.Tl.Find.Provider.Api.Connected_Services.Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://ukrlp.co.uk.server.ws.v3", ConfigurationName="Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryPortType")]
    public interface ProviderQueryPortType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="retrieveAllProvidersV3V4", ReplyAction="*")]
        [System.ServiceModel.FaultContractAttribute(typeof(Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.faultDetail), Action="retrieveAllProvidersV3V4", Name="faultDetail")]
        ...
        System.Threading.Tasks.Task<Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.response> retrieveAllProvidersV3V4Async(Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryParam request);
    }
    ...
    public partial class ProviderQueryParam
    {
        ...
        public Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryStructure ProviderQueryRequest;
        
        public ProviderQueryParam()
        {
        }
        
        public ProviderQueryParam(Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryStructure ProviderQueryRequest)
        {
    ...
    public partial class response
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://ukrlp.co.uk.server.ws.v3", Order=0)]
        public Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryResponse ProviderQueryResponse;
        
        public response()
        {
        }
        
        public response(Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryResponse ProviderQueryResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface ProviderQueryPortTypeChannel : Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class ProviderQueryPortTypeClient : System.ServiceModel.ClientBase<Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryPortType>, Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryPortType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.response> Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryPortType.retrieveAllProvidersV3V4Async(Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryParam request)
        {
            return base.Channel.retrieveAllProvidersV3V4Async(request);
        }
        
        public System.Threading.Tasks.Task<Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.response> retrieveAllProvidersV3V4Async(Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryStructure ProviderQueryRequest)
        {
            Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryParam inValue = new Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryParam();
            inValue.ProviderQueryRequest = ProviderQueryRequest;
            return ((Sfa.Tl.Find.Provider.Api.UkRlp.Api.Client.ProviderQueryPortType)(this)).retrieveAllProvidersV3V4Async(inValue);
        }
