...
//(function ($) {
    ...
    //console.log(`.... running location autocomplete...`);
    //console.log(`running location autocomplete...`);
    //console.log("does it exist? "+ $keywordsInput);
    //console.log("does it exist 2? " + $('#tl-search-term'));
    //console.log("does it exist 3? " + $('#tl-search-term').val());
    //console.log($keywordsInput.length);

    //if ($keywordsInput.length > 0) {
    //    console.log('has input');
    //}
    //$('#tl-search-term').val("hello");
    $("#tl-search-term").val("hello");
