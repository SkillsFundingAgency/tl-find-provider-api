/*
Requirements
	An employer has requested T Levels Provider data 
	so that they can build their own internal dashboard to map Providers 
	against projects, offices and partners.
*/
...
NearestLocationsCTE AS (
	...
	SELECT 	[UkPrn],
			...
			--l.[IsAdditionalData] AS [Temporary Provider Data],
			CASE WHEN l.[IsAdditionalData] = 1 THEN 'Yes'
			ELSE 'No'
			END AS [CD Completed]
...
UkPrn	Provider Name	Postcode	Location Name	Address Line 1	Address Line 2	Town	County	Email	Telephone	Website	Year of Delivery	Route Name	Qualification Name	CD Completed
